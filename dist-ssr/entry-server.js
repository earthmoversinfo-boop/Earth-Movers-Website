...
var UI = {
	en: {
		...
		"wa.msg": "Hello Earth Movers International — I would like to discuss a project.\nLocation and scope:",
		"wa.msgService": "Hello Earth Movers International — I would like a price.\nService: {service}\nLocation and scope:",
	...
	ar: {
		...
		"seo.aboutDesc": "تأسست في مونتريال عام 1990 وتعمل في دبي منذ 2005. تقدّم إيرث موفرز إنترناشيونال خدمات الأعمال الترابية وإنشاء الطرق وإدارة المرور في مختلف أنحاء الإمارات.",
		...
		"about.story2": "تأسّس فريقنا لمواجهة التحديات التي يواجهها قطاع الإنشاءات في مجالات الأعمال الترابية وإنشاء الطرق وتشغيل المعدات الثقيلة. واليوم ندعم مشاريع البنية التحتية والتجارية والصناعية في مختلف أنحاء الإمارات، بصفتنا مقاول إنشاء طرق وأعمال ترابية مقرّه دبي.",
		...
		"wa.msg": "السلام عليكم، إيرث موفرز إنترناشيونال — أرغب في مناقشة مشروع.\nالموقع ونطاق العمل:",
		"wa.msgService": "السلام عليكم، إيرث موفرز إنترناشيونال — أرغب في الحصول على عرض سعر.\nالخدمة: {service}\nالموقع ونطاق العمل:",
...
var featuredServices = [
	...
	},
	{
		...
		icon: "crane",
		img: "/images/svc-traffic-management.jpg",
		blurb: "Permits, diversions and compliant traffic management for works inside a live road corridor."
	}
];
var serviceGroups = [
	{
	...
	},
	{
		...
		intro: "The supporting scopes that sit either side of the main works — coastal, demolition and the approvals behind both.",
		services: [{
...
//#endregion
//#region src/components/WhatsAppButton.jsx
function whatsAppMessage(pathname, locale, t, tax) {
	...
	if (found.kind === "emirate") return t("wa.msgService", { service: t("loc.inEmirate", {
		name: category.name,
		emirate: found.emirate.name
	}) });
	return t("wa.msg");
}
...
function WhatsAppButton() {
	...
	return /* @__PURE__ */ jsxs("a", {
		...
		children: [/* @__PURE__ */ jsx(WhatsApp, { className: "wa-fab-icon" }), /* @__PURE__ */ jsx("span", {
