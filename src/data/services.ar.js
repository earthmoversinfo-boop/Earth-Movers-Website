...
export const categoriesAr = {
  ...
  supply: {
    ...
    intro:
      'المواد التي يُبنى منها الطريق أو المنصة، تُورَّد بالتدرّج والاختبارات التي تطلبها المواصفة. نورّد طبقة الأساس والركام والرمل والحجر وصناديق الجابيون من مصادر معتمدة، وندير النقل بأنفسنا — فتكون المادة المذكورة في سند التسليم هي المادة التي تُختبَر، ولا يوقف تأخّر حمولة عمل المدحلة.',
    services: {
      'road-base-supply': {
