...
export const serviceContentAr = {
  ...
  'rta-approved-entry-exit-works': {
    ...
    body: [
      ...
      'والانضباط نفسه ينطبق سواء كان المدخل بوابة فيلا أو واجهة معرض: توقيع وفق الهندسة المعتمدة، وتشكيل طبقة ما تحت الأساس ودمكها، وضبط خط الحواجز والانخفاض، وحماية ما يعبره، ثم التسطيح بالإنترلوك أو الأسفلت على المنسوب الذي يطلبه المخطط. وتمتد مشاريعنا في المداخل والمخارج المعتمدة من مداخل مبانٍ مفردة في قرية جميرا الدائرية إلى واجهات المعارض والمنشآت الصناعية، وهي مدرجة على صفحة المشاريع، ومدخل قرية جميرا الدائرية معروض فيها بصور من الموقع.',
    ],
    scope: [
