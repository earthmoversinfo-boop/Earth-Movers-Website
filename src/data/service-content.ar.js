...
export const serviceContentAr = {
  ...
  'rta-approved-entry-exit-works': {
    ...
    lead: 'أعمال مداخل ومخارج معتمدة من هيئة الطرق في دبي — مداخل ومخارج قطع الأراضي على طرق الهيئة، ينفّذها مقاول مداخل معتمد فيُقبَل العمل ويصبح المدخل قابلاً للاستخدام نظامياً.',
    caption: 'مدخل ومخرج معتمد من هيئة الطرق أثناء التنفيذ على واجهة القطعة.',
    intro:
      'المدخل والمخرج على طريق تابع لهيئة الطرق والمواصلات ليس عمل أحجار أرصفة. إنه وصلة منضبطة بالطريق العام، ولن تقبلها الهيئة إلا إذا كان التصميم معتمداً والمقاول معتمداً وما نُفِّذ مطابقاً لما رُسِم. والاستعانة بمقاول مداخل معتمد من الهيئة ليست خياراً في هذه الأعمال — فبدونه لا تصريح ولا تسليم.',
    body: [
      ...
      'والسبب الثاني في الشيوع هو ما تحت السطح. فواجهات القطع تحمل خطوط مياه وريّ واتصالات على عمق بضع مئات من المليمترات، ومدخلٌ يُبنى فوق خدمة غير محميّة عيبٌ سيُحفر مجدداً. لذلك حيث يعبر خط المدخل نكشفه ونحميه ونوثّقه قبل تنفيذ الطبقة السطحية.',
      'والانضباط نفسه ينطبق سواء كان المدخل بوابة فيلا أو واجهة معرض: توقيع وفق الهندسة المعتمدة، وتشكيل طبقة ما تحت الأساس ودمكها، وضبط خط الحواجز والانخفاض، وحماية ما يعبره، ثم التسطيح بالإنترلوك أو الأسفلت على المنسوب الذي يطلبه المخطط. وتمتد مشاريعنا في المداخل والمخارج المعتمدة من مداخل مبانٍ مفردة في قرية جميرا الدائرية إلى واجهات المعارض والمنشآت الصناعية، وهي مدرجة على صفحة المشاريع، ومدخلا قرية جميرا الدائرية وآرك معروضان فيها بصور من الموقع.',
    ],
    scope: [
      ...
      'حماية خطوط المياه والريّ والاتصالات التي تعبر المدخل',
    ...
    faqs: [
      ...
      {
        q: 'ما الذي يجعل المقاول مقاول مداخل معتمداً من هيئة الطرق؟',
        a: 'الاعتماد تحمله الشركة ولا يُشترى لكل مشروع. وهو يغطي الأعمال داخل حرم الطريق — المدخل نفسه وإعادة ما حوله إلى حالته وترتيبات المرور أثناء التنفيذ. ونحن نحمل هذا الاعتماد، فيصدر التصريح باسمنا ويُقبَل المدخل المنجَز على تقديمنا.',
      },
      {
        q: 'هل يمكن تنفيذ المدخل والمبنى ما يزال قيد الإنشاء؟',
        a: 'نعم، وهو غالباً الترتيب الصحيح — مدخل مؤقت منفَّذ وفق الهندسة المعتمدة يُبعِد التوريدات عن المسار ويصبح المدخل الدائم عند التسليم. وقد نُفِّذ مدخل قرية جميرا الدائرية المعروض على صفحة مشاريعنا بهذه الطريقة تماماً.',
      },
    ],
  },
